...
<head>
    ...
    <title>Registeration | Hyperdata</title>
            ...
            <div class="form-login">
                <form method="post" id="form-login" name="form-login">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" name="email" type="email" class="form-control" placeholder="Input E-mail" required>
                    </div>
                    <div class="form-group">
                        <div class="position-relative">
                            <label for="password1" class="placeholder"><b>Password</b></label>
                    ...
                    <div class="form-group">
                        <div class="position-relative">
                            <label for="password2" class="placeholder"><b>Re-enter Password</b></label>
                            <div class="input-group">
                    ...
                    <div class="form-group form-action-d-flex mb-3">
                        <button type="submit" name="submit" class="btn btn-primary col-md-12 fw-bold"><i class="fas fa-sign-in-alt"></i>&nbsp;&nbsp;Register Account</button>
                    </div>
                </form>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#form-login').submit(function(e) {
                ...
                $.ajax({
                    url: '<?= base_url("registeration/auth") ?>',
                    type: 'post',
                    data: {
                        username: username,
                        password1: password1,
                    ...
                    success: function(resp) {
                        if (resp == '1') {
                            swal("Success!", "Registeration success, directing to Login Area!", {
                                icon: "success",
                                buttons: {
                                    confirm: {
