  ...
  <form id="postform" name="postform" method="post">
    ...
    <div class="card-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="username" value="<?= ($form_type == 'edit') ? $row->username : ''; ?>" placeholder="Input Username" required />
      </div>

      <div class="form-group">
        <label for="email2">Fullname</label>
        <input type="text" class="form-control" name="name" value="<?= ($form_type == 'edit') ? $row->name : ''; ?>" placeholder="Input Fullname" required />
      </div>

      <div class="form-group">
        <label for="email2">Password</label>
        <input type="password" class="form-control" name="password" placeholder="Input Password" <?= ($form_type == 'add') ? 'required' : ''; ?>>
      </div>
    </div>
  </form>
</div>
