  ...
  <form action="<?= base_url(uri_string() . "/process") ?>" method="post">
    ...
    <div class="card-action">
      <?php if (@$formtype != "edit") { ?>
        <button type="submit" name="submit" class="btn btn-primary btn-sm pull-right"><i class="fas fa-save"></i>&nbsp;&nbsp;Save</button>
      <?php } else { ?>
        <button type="submit" name="submit" class="btn btn-primary btn-sm pull-right"><i class="fas fa-save"></i>&nbsp;&nbsp;Update</button>
      <?php } ?>
