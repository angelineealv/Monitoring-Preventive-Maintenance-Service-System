  ...
  <form action="<?= base_url(uri_string() . "/process") ?>" method="post">
    ...
    <div class="card-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="username" <?php if (@$formtype != "edit") { ?> value="<?= @$detprod["productcode"] ?>" <?php } else { ?> value="<?= $detcart["productcode"] ?>" <?php } ?> placeholder="Input Code" readonly required />
      </div>
