<div class="card box-card scrollbar-inner">
  <form action="<?= base_url(uri_string() . "/process") ?>" method="post">

    <div class="card-action">
      <?php if (@$formtype != "edit") { ?>
        <a href="<?= base_url("transaksi/order") ?>" class="btn btn-default"><i class="fas fa-reply"></i>&nbsp;&nbsp;Kembali</a>
      ...
      <?php } else { ?>
        <a href="<?= base_url("transaksi/cart") ?>" class="btn btn-default"><i class="fas fa-reply"></i>&nbsp;&nbsp;Kembali</a>
        <button type="reset" class="btn btn-warning float-right"><i class="fas fa-redo-alt"></i>&nbsp;&nbsp;Reset</button>
