<div class="main-header">
    <div class="logo-header" data-background-color="light-blue2">
        <?php if (session_value("levelid") == 4 || session_value("levelid") == 7) { ?>
            <a href="<?= base_url("transaksi/purchase") ?>" class="logo">
                <span class="text-logo">PO CABANG</span>
            </a>
        <?php } else { ?>
            <a href="<?= base_url("transaksi") ?>" class="logo">
                <span class="text-logo">PO CABANG</span>
            </a>
        <?php } ?>
    ...
    <nav class="navbar navbar-header navbar-expand-lg" data-background-color="light-blue2">
        ...
        <div class="container-fluid">
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                <li class="nav-item">
                    <span class="badge badge-info">Selamat Datang <?= session_value("username") ?></span>
                </li>
